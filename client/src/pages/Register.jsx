    ...
    <div className="min-h-[calc(100vh-64px)] flex items-center justify-center px-4 py-12">
      <div className="w-full max-w-md animate-fade-in">
        ...
        <div className="text-center mb-8">
          <div className="inline-flex items-center justify-center w-16 h-16 bg-gradient-to-br from-emerald-500 to-primary-600 rounded-2xl shadow-2xl shadow-emerald-500/30 mb-4">
            <svg
        ...
        <div className="glass-card p-8 glow-hover">
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              <label
                htmlFor="name"
                className="block text-dark-300 text-sm font-medium mb-1.5"
              >
                Full Name
              </label>
              ...
              {formData.password && (
                <div className="mt-2 space-y-1">
                  ...
                  <p className="text-xs text-dark-500">
                    ...
                    <span
                      className={
                        pwdStrength.strength >= 75
                          ? "text-emerald-400"
                          : pwdStrength.strength >= 50
                          ? "text-amber-400"
                          : "text-red-400"
                      }
                    >
            ...
            <button
              type="submit"
              disabled={loading}
              className="btn-primary w-full flex items-center justify-center gap-2 !py-3.5 !mt-6 disabled:opacity-50 disabled:cursor-not-allowed"
